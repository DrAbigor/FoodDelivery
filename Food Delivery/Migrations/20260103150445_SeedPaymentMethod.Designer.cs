...
{
    [DbContext(typeof(Food_DeliveryContext))]
    [Migration("20260103150445_SeedPaymentMethod")]
    partial class SeedPaymentMethod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDelivery.Domain.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.GroupOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.GroupOrderMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.Mall", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Domain.GroupOrder", b =>
                {
                    b.HasOne("FoodDelivery.Domain.Mall", "Mall")
            ...
            modelBuilder.Entity("FoodDelivery.Domain.GroupOrderMember", b =>
                {
                    b.HasOne("FoodDelivery.Domain.GroupOrder", "GroupOrder")
            ...
            modelBuilder.Entity("FoodDelivery.Domain.OrderItem", b =>
                {
                    b.HasOne("FoodDelivery.Domain.MenuItem", "MenuItem")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("FoodDelivery.Domain.Payment", b =>
                {
                    b.HasOne("FoodDelivery.Domain.Order", null)
                        .WithOne("Payment")
                        .HasForeignKey("FoodDelivery.Domain.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Domain.PaymentMethod", "PaymentMethods")
                        .WithMany()
                        .HasForeignKey("PaymentMethodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Domain.PaymentMethod", null)
                        .WithMany("Payments")
